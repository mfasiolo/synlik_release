...
#' @param draw    If TRUE the slice will be plotted.
...
#' @param multicore  If TRUE the object@@simulator and object@@summaries functions will
...
synSlice <- function(object, ranges, nsim, param = object@param, pairs = FALSE, draw = TRUE, trans = NULL, 
                     multicore = FALSE, ncores = detectCores() - 1, cluster = NULL, ...)
{
  ...
  funToApply <- function(parVal, ...)
  {
    ...
    synlikEval(object, param, nsim, multicore = FALSE, cluster = NULL, ...)$logLik
  }
